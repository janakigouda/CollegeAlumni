...
<div class="a">
    ...
    <ul class="ul">
        <nav class="nav">
            <ul class="ul">
                <!-- <li><a href="forget1.php?ans=$_SESSION['id'];">Back</a></li> -->
            </ul>
        </nav>
    </header>
   <br><br><br>
    ...
    <div class="form-wrap">
        <form action="" method="POST">
            ...
            <div class="container">
                ...
                <input type="password" name="pass" maxlength="10" require><br>
                <!-- <label>Confirm Your Password</label>
                <input type="password" name="pass1" maxlength="10" require><br> -->
                <hr>


                <center><input type="submit" class="btn" value="continue" name="sub"></center>
                <br>
...
// $x="UPDATE  `sslc` SET  `board` =  '$board' , `reg_or_sup` =  '$reg', `pass_year` =  '$pass' WHERE  `user`.`username` ='$user' LIMIT 1 ";
    ...
    $x="UPDATE  `register` SET `password` = '$user'
       WHERE  `ans` ='$u' LIMIT 1" ;
    $res =  mysqli_query($db,$x);
    // header('location:udash.php');
    // }
    // else{ echo "error"; }    
    echo '<script language="javascript">document.location.href="login.php?ans=Updated Your Password Sucessfully.."</script>';
}
