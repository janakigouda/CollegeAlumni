    ...
    <div class="form-wrap">
        ...
        <form action="plogin.php" method="POST">
            <div class="container">
                ...
                <hr>
                <label>Name</label>
                <input type="text" name="name" placeholder="eg:name" required><br>
                <label>Password</label>
                <input type="password" placeholder="eg:123abc" name="password" required><br>
                <hr>


                <center><input type="submit" class="btn" value="Continue" name="lagin"></center>
                <br>
