...
<body>
    ...
    <br><br><br><br>
    <div class="f">
        <form name="f" action="frnd.php" method="POST">
...
?>
    <div class="row">
        <div class="column">
            <a href="info.php?ans=<?php echo $row['name'] ?>"><img src=<?php echo $row['photo'];?>
            style='width:75%; height:130px; '></a><br>
