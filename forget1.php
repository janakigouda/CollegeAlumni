...
<div class="a">
    ...
    <ul class="ul">
        <nav class="nav">
            <ul class="ul">
                <li><a href="forget.php">Back</a></li>
            </ul>
        </nav>
    </header>
   <br><br><br>
   <?php 
    ...
    $_SESSION['id'];
    $user= $_GET['ans'];
   $q ="SELECT * FROM `register` where email='$user'";
   $r=mysqli_query($db,$q);
    ...
    <div class="form-wrap">
        <form action="f2.php" method="POST">
            ...
            <div class="container">
                ...
                <hr>
                <input type="text" name="que" value="<?php echo $row['que'];?>" readonly><br>
                <input type="text" name="answer" required><br>
                <hr>


                <center><input type="submit" class="btn" value="Next" name="lagin"></center>
                <br>
...
{
    echo '<p class="message"> <font size="5" color="black"> <i>';
    echo $_SESSION['error'];
